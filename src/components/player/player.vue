        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-left" :class="disableCls">
              <i @click="pre" class="iconfont icon-prev"></i>
            </div>
      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
        ...
        <div class="control">
          <progress-circle :radius="radius" :percent="percent">
            <i @click.stop="togglePlaying" :class="miniIcon" class="iconfont icon-mini"></i>
          </progress-circle>
        </div>
...
import {random} from 'common/js/random'
...
export default {
  ...
  methods: {
    ...
    enter(el,done) {
      const {x,y,scale} = this._getPosAndScalse()
